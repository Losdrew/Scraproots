...
FEPRetargeter::FEPRetargeter(UIKRetargeter *IKRetargeter)
{
    ...
    const UIKRigDefinition *SourceIKRig = IKRetargeter->GetIKRig(Source);
    const UIKRigDefinition *TargetIKRig = IKRetargeter->GetIKRig(Target);
...
bool FEPRetargeter::MatchLastBoneInLeafChain(TArray<FQuat> &OutDeltas, int32 ChainIndex, FEPRetargetSkeleton const &SourceSkeleton, FEPRetargetSkeleton &TargetSkeleton)
{
	...
	float RefZDotProd, RefXDotProd, ZDotProd, XDotProd;
	...
	auto IsRefXAxisAligned = EPUtils::IsAligned<0>(SourceSkeleton.RetargetGlobalPose[SrcRefBoneIndex].GetRotation(), TargetSkeleton.RetargetGlobalPose[TgtRefBoneIndex].GetRotation(), Tolerance, &RefXDotProd);
	...
	auto IsXAxisAligned = EPUtils::IsAligned<0>(SourceSkeleton.RetargetGlobalPose[SrcBoneIndex].GetRotation(), TargetSkeleton.RetargetGlobalPose[TgtBoneIndex].GetRotation(), 0.5f, &XDotProd);
	UE_LOG(EasyPose, VeryVerbose, TEXT("Matching leaf: %s (%s) - %s (%s), IsRefZAligned: %d (%f), IsZAxisAligned: %d (%f), IsRefXAxisAligned: %d (%f), IsXAxisAligned: %d (%f).")
		...
		, IsRefZAligned, RefZDotProd, IsZAxisAligned, ZDotProd, IsRefXAxisAligned, RefXDotProd, IsXAxisAligned, XDotProd);
	if (IsRefZAligned && IsRefXAxisAligned && IsZAxisAligned && IsXAxisAligned)
	{
